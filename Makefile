LANGUAGE_NAME := tree-sitter-brainfuckplus
HOMEPAGE_URL := https://github.com/nulldword/tree-sitter-brainfuckplus
VERSION := 0.1.0
DESCRIPTION := Grammar for the Brainfuck+ programming language
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/brainfuckplus '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/brainfuckplus
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/brainfuckplus
